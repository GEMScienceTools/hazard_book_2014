...
%
% 1) pdflatex qaoq
% 1a) pdflatex -shell-escape qaoq
% 2) makeindex qaoq.idx -s StyleInd.ist
% 3) biber qaoq
% 4  makeglossaries qaoq
% 4) pdflatex qaoq x 2
%
...
\noindent
   ...
   Testing procedures adopted in the development of the hazard component 
   of the OpenQuake-engine. 
   \textit{Global Earthquake Model (GEM) Technical Report 2014-09}, doi:
   10.13117/\-GEM.OPENQUAKE.\-TR2014.09, 73 pages.\\
   \hfill \\
\noindent
\noindent 
   {\bf{Disclaimer}} \hfill \\
   ...
   \vspace{0.4cm} \hfill \\
   {\bf{License}} \hfill \\
   This Report is distributed under the under the Creative Common License 
   Attribution-NonCommercial-ShareAlike 3.0 Unported (CC BY-NC-SA 3.0 - 
   \href{http://creativecommons.org/licenses/by-nc-sa/3.0/}
   {http://creativecommons.org/licenses/by-nc-sa/3.0/}). 
   You can download this Report and share it with 
   others as long as you provide proper credit, but you cannot change 
   it in any way or use it commercially. 
   \hfill \\

\noindent \textit{First printing, October 2014} % Printing/edition date
...
\label{sec:app1}
\input{./qareport/app1.tex}
%----------------------------------------------------------------------------------------
%	APPENDIX 2
%----------------------------------------------------------------------------------------
\chapterimage{chapter_head_1.pdf} % Chapter heading image
\chapter{The OQ-engine benchmark tests}
\label{sec:app2}
\input{./qareport/app2.tex}
%----------------------------------------------------------------------------------------
%	BIBLIOGRAPHY
%----------------------------------------------------------------------------------------
