...
\noindent \hfill \\
   ...
   Pagani, M., Monelli, D., Weatherill, G. A. and Garcia, J. (2014) The OpenQuake-engine Book: Hazard. \textit{Global Earthquake Model (GEM). Technical Report}\\
   \hfill \\
\noindent 
\noindent 
   {\bf{Disclaimer}} \hfill \\
   ...
   \hfill \\
   \todo[inline]{This needs to be updated or removed}
